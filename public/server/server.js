...
app.get('/trash', (req, res) => res.sendFile(path.join(__dirname, '..', 'trash.html')));
...
app.post('/api/visits', async (req, res) => {
    try {
        ...
        if (existing.length === 0) await pool.query('INSERT INTO visits (platform, page, ip_address, user_agent, matricule) VALUES (?,?,?,?,?)', [platform||'web', page||'/', ip, req.headers['user-agent']||'', matricule||null]);
